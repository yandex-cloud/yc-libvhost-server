...
static void usage(const char *cmd)
{
    ...
    printf("      ,block-size=NUM (physical) block size in bytes\n");
    printf("      ,sector-size=NUM (logical) sector size in bytes\n");
